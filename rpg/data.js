...
const BLESSINGS = [
  {k:'str', v:5, u:'%', n:'力量的祝福：武器攻擊 +5%'},
  {k:'crit', v:10, u:'%', n:'銳利的祝福：爆擊率 +10%'},
  {k:'vamp', v:12, u:'%', n:'血契的祝福：攻擊吸血 12%'},
  {k:'plate', v:10, u:'%', n:'守勢的祝福：每場戰鬥開始獲得 10% 最大生命的格擋'},
  {k:'hp', v:15, n:'堅韌的祝福：生命上限 +15'},
];
// 這些祝福為「死值」會被深層輾過，隨深度/輪迴縮放（見 blessMult）。
// 率型/乘率型不需要（百分比本來就跟著本體長大），所以 v436 把 str 移出後只剩 hp。
const BLESS_SCALE_KEYS = {hp:1};
...
const BLESS_CYC = [0.8, 2.8, 6.5];          // 祝福縮放的輪迴係數：沿用舊 CYC_VAL 值凍結，與裝備管線脫鉤（改裝備不再連動祝福）
