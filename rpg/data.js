...
const REALMS = [
  ...
  {n:'沉沒王國', i:'🏛️', from:11, to:20,  rule:'drain1', intro:'一座整個沉進深淵的古國。街道還在，只是走在上面的東西換了。水從天花板往上流。\n\n水淹沒到胸口——此域每場戰鬥首回合行動點 −1。'},
  {n:'血肉迴廊', i:'🫁', from:21, to:30,  rule:'heal75', intro:'牆壁是溫的，而且有脈搏。你走的不是通道，是血管。\n\n此域一切回復效果 -25%。'},
  {n:'無光教區', i:'🕯️', from:31, to:40,  rule:'dodge12', intro:'地底的教團在這裡崇拜深淵。他們縫上了自己的眼睛——「看不見的信仰才純粹」。\n\n燭火全是冷的——此域敵人有 12% 機率閃避你的攻擊（首領除外）。'},
  {n:'心室',     i:'🫀', from:41, to:50,  rule:'rage5', intro:'越走越熱，牆壁的搏動和你的心跳漸漸同步。你已經在它的心臟裡了。\n\n心跳催促著殺意——此域敵人第 5 回合起就陷入狂怒。'},
...
const STAT_DIV = [[100,4],[200,8],[Infinity,16]]; // 素質→率 分段換算 (§5)：前100÷4、100-200÷8、200+÷16（已減半，素質換率效率×2）
...
const CYC_NEXT = 50;                          // 輪迴 N 認證深度達此值解鎖 N+1（逃離才算，可調）
